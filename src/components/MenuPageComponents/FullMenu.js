    ...
    return (
        <div className="container-fluid">
            ...
            <div className="row">
                ...
                <div className="col-10 col-md-3">
                    <h5>Spicy Wings<i className="fa fa-star"></i></h5>
            ...
            <div className="row">
                <div className="col-10 col-md-3">
                    <h5>Tom Yam<i className="fa fa-star"></i></h5>
            ...
            <div className="row">
                ...
                <div className="col-10 col-sm-7 col-md-3">
                    <h5>Sukiyaki Soup<i className="fa fa-star"></i><i className="fa fa-star"></i></h5>
            ...
            <div className="row">
                <div className="col-10 col-sm-7 col-md-3">
                    <h5>Green Curry Fried Rice<i className="fa fa-star"></i><i className="fa fa-star"></i></h5>
            ...
            <div className="row">
                <div className="col-10 col-sm-7 col-md-3">
                    <h5>Pik Pow Fried Rice<i className="fa fa-star"></i></h5>
            ...
            <div className="row">
                <div className="col-10 col-sm-7 col-md-3">
                    <h5>Tom Yam Noodle Soup<i className="fa fa-star"></i></h5>
                ...
                <div className="col-10 col-sm-7 col-md-3">
                    <h5>Basil Fried Rice (Chicken, Beef, Pork or Tofu)<i className="fa fa-star"></i><i
                            className="fa fa-star"></i></h5>
            ...
            <div className="row">
                <div className="col text-center">
                    ...
                    <h5 className="mb-5">Served with your choice of white or brown rice.</h5>
                </div>
            </div>
            <div className="row">
                <div className="col">
            ...
            <div className="row">
                <div className="col-10 col-md-4">
                    <h5>Yellow Curry<i className="fa fa-star"></i></h5>
            ...
            <div className="row">
                <div className="col-10 col-md-4">
                    <h5>Massaman Curry<i className="fa fa-star"></i></h5>
                ...
                <div className="col-10 col-md-4">
                    <h5>Seafood Rama Garden<i className="fa fa-star"></i></h5>
            ...
            <div className="row">
                ...
                <div className="col-10 col-md-4">
                    <h5>Red Curry<i className="fa fa-star"></i></h5>
            ...
            <div className="row">
                <div className="col-10 col-md-4">
                    <h5>Basil<i className="fa fa-star"></i><i className="fa fa-star"></i></h5>
                    <p>Onions, peppers, mushrooms and basil leaves.</p>
                </div>
                <div className="col-10 col-md-4">
                    <h5>Panang Curry<i className="fa fa-star"></i></h5>
                    <p>Peppers, green peas, baby corns, snow peas, mushroom and basil leaves.</p>
                </div>
                <div className="col-10 col-md-4">
                    <h5>Ginger<i className="fa fa-star"></i></h5>
            ...
            <div className="row">
                <div className="col-10 col-md-3">
                    <h5>Chicken Cashew Nuts<i className="fa fa-star"></i></h5>
                ...
                <div className="col-10 col-md-3">
                    <h5>Chicken Gaprow<i className="fa fa-star"></i></h5>
            ...
            <div className="row">
                <div className="col-10 col-md-3">
                    <h5>Beef Macadamia<i className="fa fa-star"></i></h5>
                ...
                <div className="col-10 col-md-3">
                    <h5>Pad Pik King<i className="fa fa-star"></i><i className="fa fa-star"></i></h5>
            ...
            <div className="row">
                ...
                <div className="col-10 col-md-3">
                    <h5>Mango Curry<i className="fa fa-star"></i></h5>
            ...
            <div className="row">
                <div className="col-10 col-md-3">
                    <h5>Wild Boar Basil<i className="fa fa-star"></i><i className="fa fa-star"></i></h5>
                ...
                <div className="col-10 col-md-3">
                    <h5>Duck Choo Chee<i className="fa fa-star"></i></h5>
            ...
            <div className="row">
                <div className="col-10 col-md-3">
                    <h5 className=" text-nowrap">Spicy Catfish<i className="fa fa-star"></i></h5>
                ...
                <div className="col-10 col-md-3">
                    <h5>Siam Chili Fish<i className="fa fa-star"></i></h5>
                ...
                <div className="col-10 col-md-3">
                    <h5>Siam Madness<i className="fa fa-star"></i><i className="fa fa-star"></i><i
                            className="fa fa-star"></i></h5>
            ...
            <div className="row">
                <div className="col-10 col-md-3">
                    <h5 className=" text-nowrap">Spicy Mussels<i className="fa fa-star"></i><i
                            className="fa fa-star"></i></h5>
                    <p>Lightly battered fillet pieces of catfish quick sauteed with red and green
                        peppers, string beans, basil leaves and Thai herbs.</p>
                </div>
                ...
                <div className="col-10 col-md-3">
                    <h5>Steamed Ginger Fish<i className="fa fa-star"></i></h5>
                ...
                <div className="col-10 col-md-3">
                    <h5>Steamed Lime Tilapia<i className="fa fa-star"></i><i className="fa fa-star"></i></h5>
                    <p>Sauteed shrimp, scallop, squid, salmon fillet and fresh mussels with onions,
                        peppers, mushrooms in hot basil chili sauce, served on Sizzling hot plate.</p>
                </div>
                <div className="col-2 col-md-1">
            ...
            <div className="row">
                ...
                <div className="col-10 col-md-3">
                    <h5>Paradise Shrimp<i className="fa fa-star"></i></h5>
            ...
            <div className="row">
                ...
                <div className="col-10 col-md-3">
                    <h5>Curry Salmon<i className="fa fa-star"></i></h5>
                ...
                <div className="col-10 col-md-3">
                    <h5>Scallop Pik Pow<i className="fa fa-star"></i></h5>
