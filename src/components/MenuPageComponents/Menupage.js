        ...
        <div class="row">
            <div class="col" id="menu">
                <ul class="nav nav-tabs">
                    <li class="nav-item"><a class="nav-link active" href="#fullmenu" role="tab"
                            data-toggle="tab">Full Menu</a>
                    </li>
                    <li class="nav-item"><a class="nav-link" href="#lunchspecials" role="tab"
                            data-toggle="tab">Lunch Specials</a>
                    </li>
                </ul>
                
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane fade show active" id="fullmenu">
                        <div class="row mt-3">
                        ...
                        <div class="row">
                            <div class="col">
                                <i class="fa fa-star"></i> Mild
                                <i class="fa fa-star"></i><i class="fa fa-star"></i>Spicy
                                <i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i>Hot
                                and Spicy
                            </div>
                        </div>
                    </div>
        
                    <div role="tabpanel" class="tab-pane fade" id="lunchspecials">
                        <div class="row mt-3">
                            <div class="col text-center">
                                <h1 class="mb-4 menuheadings">LUNCH SPECIALS</h1>
                                <h4>Available Tuesday through Friday 11:30am-3:00pm</h4>
                                <h5>Served with thai rolls, ravioli and choice of white or brown rice</h5>
                                <img src="assets/menu.png" alt="Bangkok Hill Logo" />
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-2 col-md-1">
                                <p class="text-nowrap">$ 10.00</p>
                            </div>
                            <div class="col-10 col-md-3">
                                <h5>Pad Pik King<i class="fa fa-star"></i><i class="fa fa-star"></i></h5>
                                <p>Stir-fried chicken and shrimp with crispy stringbeans, carrots, red peppers and
                                    red curry paste in tasty brown sauce topped with cashew nuts.</p>
                            </div>
                            <div class="col-2 col-md-1">
                                <p class="text-nowrap">$ 10.00</p>
                        ...
                        <div class="row">
                            ...
                            <div class="col-10 col-md-3">
                                <h5>Tofu Pik Pow<i class="fa fa-star"></i></h5>
                                <p>Sauteed frieded tofu and an assorted of vegetable and pik pow sauce served with
                        ...
                        <div class="row mb-5">
                            <div class="col-10 col-md-3">
                                <h5>Yellow Curry (chicken, beef or tofu)<i class="fa fa-star"></i></h5>
                                <p>Peppers, pineapple chunks, yellow squash, zucchini, tomatoes, and onions.</p>
                            </div>
                            <div class="col-2 col-md-1">
                                <p class="text-nowrap">$ 10.00</p>
                            ...
                            <div class="col-10 col-md-3">
                                ...
                                <p>Thai style stir-fried minced chicken with chile sauce, red and green peppers, red
                                    onions, and basil leaves</p>
                            </div>
                            <div class="col-2 col-md-1">
                                <p class="text-nowrap">$ 10.00</p>
                            ...
                            <div class="col-10 col-md-3">
                                ...
                                <p>Crispy tilapia fillet with shredded ginger, onions, mushrooms, & peppers</p>
                            </div>
                            <div class="col-2 col-md-1">
                                <p class="text-nowrap">$ 11.00</p>
                            </div>
