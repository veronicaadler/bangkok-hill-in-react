      ...
      <div className="container-fluid">
        <div className="row">
          ...
          <div className="col text-center pb-5">
            ...
            <a
              role="button"
              className="btn btn-link socialbtn"
              href="https://www.facebook.com/pages/category/Thai-Restaurant/Bangkok-Hill-Restaurant-100878276623709/"
            >
          ...
          <div className="col-sm-4 text-center text-sm-right">
            <h5>Address</h5>
            <address>
              177 Massachusetts Avenue <br />
              Lunenburg, MA 01462
            </address>
            <h5>Call Us</h5>
            <a href="tel:+19783430555">978-343-0555</a>
            <br />
        ...
        <div className="row mt-3">
          <div className="col">
            <p className="text-center">
              This is a fictional website created for Bangkok Hill, a Thai
              restaurant in Lunenburg, MA, USA for educational purposes only.
              Please visit{" "}
              <a href="http://www.bangkokhill.com/" id="bangkoklink">
